  ...
  <div class="form">
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <form id="Sign-UpForm" action="SignupProcess.php" method="post">
          ...
          <div class="top-row">
            <div class="field-wrap">
              ...
              <input type="text" required autocomplete="off" name="CFname" />
            </div>
            ...
            <div class="field-wrap">
              ...
              <input type="text"required autocomplete="off" name="CLname" />
            </div>
          </div>
          ...
          <div class="field-wrap">
           ...
           <div class="field-wrap">
              ...
              <input type="number" required autocomplete="off" name="CPNo" />
            </div>
          ...
          <div class="field-wrap">
            ...
            <input type="password"required autocomplete="off" name="CPsw" />
          </div>
        ...
        <div id="login">   
          ...
          <form id="Sign-inForm" action="SignupProcess.php" method="post">
